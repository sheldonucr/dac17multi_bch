...
Recently EM models for multi-branch interconnect tree have been
...
I% n this work, for the first time, we propose an analytic method to
...
In this paper, we propose a new analyic expression hydrstatic stress

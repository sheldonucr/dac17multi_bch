...
segment as done before. As a result, we have to analyze all the stress
evolution as a whole instead of treating each segment seperately as
done in the existing EM assessment methods.

...
simple wire strucutres.  For practical VLSI chips, the interconnects
...
wire loaded with DC voltage distribuation as shown in
...
segment seperately as with exsting methods. As a result, we have to
analyze all the stress evolution as a whole instead of treating each
segment seperately as done in the existing EM assessment methods.
...
expressions are still cann't be applied to more general structures

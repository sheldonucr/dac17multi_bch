...
work is that it totally ignores all the dynamic evolutions of stress
...
the time-dependent hydrostatic evolution of hydrostatic stress
...
are then computed in terms of voltages and wire layout
...
critical stress. But this method still can't give the time to predict
the wire fail for the immortality check. A good research effort was
